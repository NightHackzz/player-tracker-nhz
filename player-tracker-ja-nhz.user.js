...
// @category       Layer
// @version        0.11.1.20170329.ja.nhz.0003
...
// @description    [2017-03-29.0003] PlayerTracker(nhz) トレース色、追跡、履歴時間指定版.
...
function wrapper(plugin_info) {
    ...
    plugin_info.dateTimeVersion = '20170329.0003';
    ...
    window.PLAYER_TRACKER_LINE_COLOUR_RES = '#ffffe0';
